...
import { formatMessageTime } from '../lib/utlils';
      ...
      <div className='flex-1 overflow-y-auto p-4 space-y-4'>
        {messages.map((message)=>(
          ...
          className={`chat ${message.senderId == authUser._id? "chat-end": "chat-start"}`}>
            ...
            <div className='chat-headere mb-1 '><time className='text-xs opacity-50 ml-1'>{formatMessageTime(message.createdAt)}</time></div>
